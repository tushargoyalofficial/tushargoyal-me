      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section delay={0.3}>
          <WorkGridItem id="aptstudy" title="APT Study" thumbnail={aptstudy}>
            A mobile application where CA aspirants can attend coaching classes,
            purchase lectures and tests, give exams, self-assessments.
          </WorkGridItem>
        </Section>{' '}
        <Section delay={0.3}>
          <WorkGridItem id="gofundher" title="GoFundHer" thumbnail={gofundher}>
        ...
        <Section delay={0.3}>
          ...
          >
            A web application where user can create and show presentations using
            images, videos, & PDFs. User can even share it by sending a unique
            link generated after creating a presentation.
          </WorkGridItem>
        </Section>{' '}
        <Section delay={0.3}>
          <WorkGridItem id="radlearn" title="RadLearn AI" thumbnail={radlearn}>
            A platform where you can upload MRI/XRAYS/CITI Scans and can mark
            annotations, as per the studies done by doctors/radiologist. This is
            specifically made for Medical use only.
          </WorkGridItem>
        </Section>{' '}
        <Section delay={0.3}>
